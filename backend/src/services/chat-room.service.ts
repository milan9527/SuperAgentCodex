...
export class ChatRoomService {
  ...
  async createRoomFromScope(
    ...
    const agents = scope.agents as Array<{ id: string }> | undefined;
  ...
  async createCrossScopeRoom(
    ...
    const primaryScopeId = options.primaryScopeId ?? firstMember.scopeId;
  ...
  async suggestAgentForRoom(
    ...
    if (session.business_scope_id) {
      ...
      if (scope) {
        ...
        scopeDesc = scope.description ?? undefined;
      }
    }
