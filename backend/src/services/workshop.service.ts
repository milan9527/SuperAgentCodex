...
export class WorkshopService {
  ...
  async consolidateChat(
    ...
    // The skill-creator may write new skills to the workspace root
    // (e.g. workspace/my-skill/) rather than the runtime's installed skills directory.
    ...
    try {
      ...
      for (const entry of entries) {
        ...
        // Skip runtime config, VCS, and other hidden directories.
    ...
    // Also check the active runtime's installed skills directory.
    try {
    ...
    } catch { /* no active skills directory */ }
