...
export class WorkflowExecutionService extends EventEmitter {
  ...
  private async buildExecutionContext(
    ...
    const workflowId = executionRecord.workflow_id as string | undefined;
    const organizationId = executionRecord.organization_id as string | undefined;
    const userId = executionRecord.user_id as string | undefined;
