...
vi.mock('../../src/repositories/chat.repository.js', () => ({
  chatSessionRepository: {
    ...
    updateStatus: vi.fn().mockResolvedValue({ id: 'session-1' }),
    updateProviderThread: vi.fn().mockResolvedValue({ id: 'session-1' }),
...
vi.mock('../../src/services/agent-metrics.service.js', () => ({
  recordAgentEvent: vi.fn().mockResolvedValue(undefined),
}));
