...
vi.mock('../../src/setup/index.js', () => ({
  ...
  startScheduleProcessor: vi.fn(),
  stopScheduleProcessor: vi.fn(),
  startProjectAutoProcessor: vi.fn(),
  stopProjectAutoProcessor: vi.fn(),
}));

vi.mock('../../src/services/briefing-scheduler.service.js', () => ({
  briefingScheduler: {
    start: vi.fn(),
    stop: vi.fn(),
  },
