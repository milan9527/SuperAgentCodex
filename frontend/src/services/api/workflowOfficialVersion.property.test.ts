  ...
  describe('Property 7: Default Official Version Fetch', () => {
    ...
    describe('Interface Compatibility', () => {
      ...
      it('SupabaseWorkflowService should support options parameter', () => {
        ...
        expect(SupabaseWorkflowService.getWorkflows({ includeAll: true }).catch(() => {})).toBeInstanceOf(Promise);
      });
    });
    ...
    describe('Async Behavior', () => {
      it('all methods should return promises', () => {
        ...
        expect(SupabaseWorkflowService.getWorkflows().catch(() => {})).toBeInstanceOf(Promise);
        expect(SupabaseWorkflowService.getWorkflowById('any-id').catch(() => {})).toBeInstanceOf(Promise);
        expect(SupabaseWorkflowService.getWorkflowsByCategory('hr').catch(() => {})).toBeInstanceOf(Promise);
        expect(SupabaseWorkflowService.getWorkflowVersions('name').catch(() => {})).toBeInstanceOf(Promise);
      });
    });
