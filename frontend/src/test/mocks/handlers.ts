...
export const handlers = [
  ...
  http.get('/api/skills/marketplace/featured', () => {
    return HttpResponse.json({ data: [] })
  }),

  http.get('/api/skills/enterprise', () => {
  ...
  http.get('/api/business-scopes/:id', ({ params }) => {
    return HttpResponse.json({ id: params.id, settings: {} })
  }),

  http.get('/api/workflows/checkpoints/pending', () => {
    return HttpResponse.json([])
  }),
