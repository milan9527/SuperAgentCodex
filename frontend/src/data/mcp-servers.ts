 ...
 * scope. It mirrors the provider-neutral workspace MCP configuration so it can
 * be rendered into `.codex/config.toml` without losing structure.
 */
...
export interface McpServerEntry {
  ...
  config?: {
     ...
     * Matches one entry in `.runtime/mcp-servers.json`.
     */
